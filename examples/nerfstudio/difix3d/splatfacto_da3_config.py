"""MethodSpecification for `splatfacto-da3` — splatfacto seeded from a DA3 PLY."""
...
from difix3d.splatfacto_da3 import SplatfactoDA3ModelConfig

splatfacto_da3_method = MethodSpecification(
    config=TrainerConfig(
        method_name="splatfacto-da3",
        ...
        pipeline=VanillaPipelineConfig(
            ...
            model=SplatfactoDA3ModelConfig(),
        ),
        optimizers={
            "means": {
    ...
    description="Splatfacto initialized from a DA3-produced 3DGS PLY",
)
